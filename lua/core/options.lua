...
-- Fix display issues on terminal resize
vim.api.nvim_create_autocmd('VimResized', {
  group = vim.api.nvim_create_augroup('resize_fix', { clear = true }),
  callback = function()
    vim.cmd('tabdo wincmd =')
    vim.cmd('redraw!')
  end,
  desc = 'Fix display on resize',
})

-- Diagnostic configuration (VSCode-like inline errors)
