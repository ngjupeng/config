  ...
  config = function()
    vim.api.nvim_create_autocmd('LspAttach', {
      ...
      callback = function(event)
        ...
        -- Hover documentation (like VSCode)
    ...
    local servers = {
      ...
      ts_ls = {},
      eslint = {}, -- Better linting for JS/TS
    ...
    vim.list_extend(ensure_installed, {
      ...
      'prettierd', -- Fast prettier daemon for JS/TS/HTML/CSS/JSON/YAML/MD
    ...
    -- Cairo LSP (install via: curl -L https://install.starknet.io | bash && starkliup)
    -- or via scarb: https://docs.swmansion.com/scarb/download
